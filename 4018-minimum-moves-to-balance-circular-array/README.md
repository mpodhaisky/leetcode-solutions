...
<p>Thus, the minimum number of moves required is 6.âââ</p>
</div>
...
<p><strong>âââââââ</strong>It is impossible to make all balances non-negative for <code>balance = [-3, 2]</code>, so the answer is -1.</p>
</div>
